    ...
    <div className="w-full max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
      ...
      >
        ...
        <h1 className="text-6xl lg:text-7xl font-bold mb-6 leading-tight">
          RUN<br />
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FF5A1F] to-[#FF8C42]">TOGETHER</span>
        </h1>
        ...
        <div className="rounded-2xl border border-white/10 bg-white/[0.03] backdrop-blur-xl p-8 sm:p-10">
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-gray-400">
              We&apos;re building something amazing. Authentication is coming shortly.
            </p>
          </div>
          ...
          <p className="mt-6 text-center text-xs text-gray-500">
            Already part of the waitlist? Check your email for updates.
          </p>
        </div>
      </motion.div>
    </div>
